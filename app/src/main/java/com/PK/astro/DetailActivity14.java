...
public class DetailActivity14 extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener {
            ...
            public void onResponse(Call<List<YourResponseItem>> call, Response<List<YourResponseItem>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (YourResponseItem item : data) {
                        ...
                        Glide.with(DetailActivity14.this)
                ...
                runOnUiThread(() -> {
                    ...
                    if (pdfFile.exists()) {
                        pdfView.fromFile(pdfFile)
                                ...
                                .onPageChange(DetailActivity14.this)
    ...
    private void showToast(String message) {
        Toast.makeText(DetailActivity14.this, message, Toast.LENGTH_SHORT).show();
    }
