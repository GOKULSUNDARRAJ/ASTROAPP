...
public class DetailActivity11 extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener {
            ...
            public void onResponse(Call<List<YourResponseItem>> call, Response<List<YourResponseItem>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (YourResponseItem item : data) {
                        ...
                        Glide.with(DetailActivity11.this)
                ...
                runOnUiThread(() -> {
                    ...
                    if (pdfFile.exists()) {
                        pdfView.fromFile(pdfFile)
                                ...
                                .onPageChange(DetailActivity11.this)
    ...
    private void showToast(String message) {
        Toast.makeText(DetailActivity11.this, message, Toast.LENGTH_SHORT).show();
    }
