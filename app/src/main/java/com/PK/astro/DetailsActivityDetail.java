...
public class DetailsActivityDetail extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener {
            ...
            public void onResponse(Call<List<YourResponseItem>> call, Response<List<YourResponseItem>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (YourResponseItem item : data) {
                        ...
                        Glide.with(DetailsActivityDetail.this)
                ...
                runOnUiThread(() -> {
                    ...
                    if (pdfFile.exists()) {
                        pdfView.fromFile(pdfFile)
                                ...
                                .onPageChange(DetailsActivityDetail.this)
    ...
    private void showToast(String message) {
        Toast.makeText(DetailsActivityDetail.this, message, Toast.LENGTH_SHORT).show();
    }
